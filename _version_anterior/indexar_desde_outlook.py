...
class OutlookIndexer:
    ...
    def indexar_carpeta(self, folder_name="Bandeja de entrada", progress_callback=None):
        """Indexar carpeta de Outlook"""
        ...
        try:
            ...
            # Buscar carpeta específica si no es Bandeja de entrada
    ...
    def indexar_todas_carpetas(self, progress_callback=None):
        """Indexar todas las carpetas de Outlook"""
        if not self.connect_outlook():
            return 0
        ...
        try:
            ...
            for folder in inbox.Parent.Folders:
                ...
                count = self.indexar_carpeta_obj(folder, progress_callback)
    ...
    def indexar_carpeta_obj(self, folder, progress_callback=None):
        """Indexar objeto de carpeta específico"""
        try:
...
def main():
    ...
    print("Ahora puedes buscar en el Buscador de Correos\n")
