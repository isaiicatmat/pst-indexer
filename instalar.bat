...
REM Intentar instalar libpst-python
echo Instalando libpst-python (esto puede tardar unos minutos)...
python -m pip install libpst-python 2>nul
if errorlevel 1 (
    echo ⚠️  Advertencia: No se pudo instalar libpst-python
    echo   Algunos archivos PST podrían no funcionar correctamente
)
